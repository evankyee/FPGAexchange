...
HD_PWD='C:/Users/eal63/Desktop/FPGAexchange/final_proj.runs/impl_1/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WrapperBook.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WrapperBook.tcl
