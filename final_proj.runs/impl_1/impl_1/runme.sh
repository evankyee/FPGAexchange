...
HD_PWD='C:/Users/eal63/Desktop/FPGAexchange/final_proj.runs/impl_1/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log WrapperBook.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source WrapperBook.tcl -notrace
